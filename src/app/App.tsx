...
import { EducacionPage } from '../pages/Tab3';
  ...
  <IonApp>
    <IonReactRouter>
      <IonRouterOutlet>
        ...
        <Route exact path="/educacion" component={EducacionPage} />
        <Route exact path="/denuncias" render={() => <PlaceholderPage title="Denuncias" />} />
        <Route exact path="/cuestionarios" component={CuestionariosPage} />
        <Route exact path="/protocolos" component={ProtocolosPage} />
